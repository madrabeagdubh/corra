...
export default class TerrainManager {
  constructor(scene, player) {
    ...
    this.terrainTypes = {
      ...
      deepBog: {
        ...
        walkable: true,
        requiresCheck: true,
        onEnter: (player) => { console.log('Entered deep bog') },
        onExit:  (player) => { console.log('Exited deep bog') }
      }
    };
  ...
  getTerrainByTileType(tileType) {
    ...
    return this.terrainTypes.normal;
  }
  ...
  applyContinuousEffects(terrain) {
    // Guard: only run on a properly initialised Phaser scene
